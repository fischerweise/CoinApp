...
extension CoinListViewController: CoinListDisplaying {
    
    func displayCoinList(viewModel: CoinListModel.SetUp.ViewModel?) {
        guard let viewModel = viewModel else {
            self.showAlert(title: "Alert", message: "An error has occurred.")
            return
        }
